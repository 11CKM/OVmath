...
void _ui_screen_change(lv_obj_t ** target, lv_scr_load_anim_t fademode, int spd, int delay, void (*target_init)(void))
{
    ...
    if(*target == NULL) {
        ...
        // 为目标屏幕添加卸载时的销毁回调
        // 根据目标屏幕指针确定对应的销毁函数
        if(*target == ui_SizeScreen) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_SizeScreen_screen_destroy);
        } else if(*target == ui_TScreen) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_TScreen_screen_destroy);
        } else if(*target == ui_DateScreen) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_DateScreen_screen_destroy);
        } else if(*target == ui_bybyScreen) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_bybyScreen_screen_destroy);
        } else if(*target == ui_Hand) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_Hand_screen_destroy);
        } else if(*target == ui_Screen7) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_Screen7_screen_destroy);
        } else if(*target == ui_TICK) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_TICK_screen_destroy);
        } else if(*target == ui_Screen8) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_Screen8_screen_destroy);
        } else if(*target == ui_Screen1) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_Screen1_screen_destroy);
        } else if(*target == ui_WeclomeScreen) {
            lv_obj_add_event_cb(*target, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_WeclomeScreen_screen_destroy);
        }
    }
